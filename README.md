...
### Lv4 추가 발견 (PPO 침범 정도 분석)

전체 1,302명 평가 (기존 평가):

| 정책 | Completion | HH 침범 월수 | 단일월 최대비 | 상위 5% 셀러 최대비 |
|---|---|---|---|---|
| Fixed-0.15 | 79.7% | 20.7 | 1.26 | 2.52 |
| **CVaR** | 0% | 20.7 | **0.32** | **0.99** |
| **PPO** | **92.4%** | **12.2** | 1.73 | 3.60 |

- PPO는 침범 **빈도** 41% 감소, 회수율 92% 달성 (robust, train-test 격차 1.6%p)
- 그러나 **침범 강도** 측면은 1.73 (가계비의 3.6배까지) — CVaR(0.32, 0.99) 대비 약점
- → 단순 reward 조정으로 해결 안 됨 (η 5x 강화 / 분포 통합 / X1 비례 모두 시도)
- → 본질 해결: **사전 적합도 평가 + 정책 선택**
